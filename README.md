...
*Abaixo está uma seleção dos meus repositórios. A lista é atualizada automaticamente!*

<!-- START_AUTO_REPOS -->
<!-- A lista de repositórios será inserida aqui automaticamente pelo GitHub Actions -->
**🚀 Carregando projetos...**
<!-- END_AUTO_REPOS -->
...
## 💡 Sobre Mim
- 🎓 **Formação:** Cursando ou formado em Ciência da Computação / Sistemas de Informação.
- 💼 **Interesses:** Desenvolvimento Backend, APIs, Cloud Computing e aprender linguagens modernas como Go e Rust[citation:1][citation:7].
- 🎯 **Objetivo:** Construir projetos impactantes e contribuir com a comunidade de código aberto.
